...
public class GaugeView extends View {
    ...
    boolean mShowOuterShadow;
    boolean mShowOuterBorder;
    boolean mShowOuterRim;
    boolean mShowInnerRim;
    boolean mShowScale;
    boolean mShowRanges;
    boolean mShowNeedle;
    boolean mShowText;

    float mOuterShadowWidth;
    float mOuterBorderWidth;
    float mOuterRimWidth;
    float mInnerRimWidth;
    float mInnerRimBorderWidth;
    float mNeedleWidth;
    float mNeedleHeight;

    float mScalePosition;
    float mScaleStartValue;
    float mScaleEndValue;
    float mScaleStartAngle;
    float mScaleEndAngle;
    float[] mRangeValues;
    ...
    RectF mOuterShadowRect;
    RectF mOuterBorderRect;
    RectF mOuterRimRect;
    RectF mInnerRimRect;
    RectF mInnerRimBorderRect;
    RectF mFaceRect;
    RectF mScaleRect;

    Bitmap mBackground;
    Paint mBackgroundPaint;
    Paint mOuterShadowPaint;
    Paint mOuterBorderPaint;
    Paint mOuterRimPaint;
    Paint mInnerRimPaint;
    Paint mInnerRimBorderLightPaint;
    Paint mInnerRimBorderDarkPaint;
    Paint mFacePaint;
    Paint mFaceBorderPaint;
    Paint mFaceShadowPaint;
    Paint[] mRangePaints;
    Paint mNeedleRightPaint;
    Paint mNeedleLeftPaint;
    Paint mNeedleScrewPaint;
    Paint mNeedleScrewBorderPaint;
    Paint mTextValuePaint;
    Paint mTextUnitPaint;
    ...
    float mTextValueSize;
    float mTextUnitSize;

    Path mNeedleRightPath;
    Path mNeedleLeftPath;

    // *--------------------------------------------------------------------- *//

    float mScaleRotation;
    float mDivisionValue;
    float mSubdivisionValue;
    ...
    String valueString(final float value) {
        return String.format("%d", (int) value);
    }

    public float getValueForTick(final int tick) {
        return mScaleStartValue + tick * (mDivisionValue / mSubdivisions);
    }

    public Paint getRangePaint(final float value) {
        final int length = mRangeValues.length;

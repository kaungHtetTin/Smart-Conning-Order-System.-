...
public class JoystickView extends View implements Runnable {
    ...
    // Variables
     OnJoystickMoveListener onJoystickMoveListener; // Listener
     Thread thread = new Thread(this);
     long loopInterval = DEFAULT_LOOP_INTERVAL;
     int xPosition = 0; // Touch x position
     int yPosition = 0; // Touch y position
     double centerX = 0; // Center view x position
     double centerY = 0; // Center view y position
     Paint mainCircle;
     Paint secondaryCircle;
     Paint button;
     Paint horizontalLine;
     Paint verticalLine;
     int joystickRadius;
     int buttonRadius;
     int lastAngle = 0;
